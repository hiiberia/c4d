...
class LidarTest:
    ...
    def execute(self):
        ...
        airsim.wait_key('Press any key to move vehicle to (15, 0, -15) at 5 m/s')
        #self.client.moveToPositionAsync(-10, 10, -10, 5).join()
        self.client.moveToPositionAsync(15, 0, -15, 5).join()
        ...
        for i in range(1,5):
            ...
            lidarData = self.client.getLidarData(lidar_name="LidarSensor1", vehicle_name=
            "Drone1");
            print(lidarData)
            if (len(lidarData.point_cloud) < 3):
                ...
                print("\tReading %d: time_stamp: %d number_of_points: %d" % (i,
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('-save-to-disk', type=bool, help="save Lidar data to disk",
                            default=False)
